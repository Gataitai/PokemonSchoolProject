<script>
    ...
    const fetchAuction = async (event) => {
        ...
        if(data.error){
            ...
            pokemonId = data.auction.pokemon.id;
...
<form class="form" on:submit|preventDefault={update}>
    <div class="field">
            <span class="name">
                Auction id
            </span>
    ...
    {#if startingPrice && pokemonId && endDate}
        ...
        <button class="submit" type="submit">Update auction</button>
